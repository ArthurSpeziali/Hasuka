{-# LANGUAGE MultiParamTypeClasses, FunctionalDependencies, BangPatterns, UndecidableInstances #-}
...
instance {-# OVERLAPPABLE #-} (Monad m, Monad (t m), MonadTrans t, NameMonad n m) => NameMonad n (t m) where

{-# LANGUAGE ViewPatterns, ParallelListComp, NondecreasingIndentation, RecordWildCards #-}
...
instance Semigroup FieldMap where
    FieldMap a b <> FieldMap c d = FieldMap (a `mappend` c) (b `mappend` d)

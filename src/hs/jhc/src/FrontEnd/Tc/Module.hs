{-# LANGUAGE ParallelListComp, ViewPatterns, RecordWildCards #-}
...
getDataDesc :: Fail.MonadFail m => HsDecl -> m (Name,DatDesc)
getDataDesc d = g d where
    ...
    f _ = Fail.fail "getDataDesc: not a data declaration"

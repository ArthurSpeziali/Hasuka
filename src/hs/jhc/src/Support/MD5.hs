...
{-# OPTIONS_GHC -optl /home/bruns/Documents/HanonymOS/jhc-0.8.2/src/cbits/md5sum.o -optl /home/bruns/Documents/HanonymOS/jhc-0.8.2/src/cbits/lookup3.o #-}
module Support.MD5(
...
md5Handle h = do
    ...
    allocaBytes len $ \ptr -> do
        ...
        unless (cnt == len) $ Fail.fail "md5File - read returned too few bytes"
        hSeek h AbsoluteSeek 0
        allocaBytes 16 $ \digest -> do

...
processOptions = do
    ...
    case optMode o of
        ...
        Version     -> putStrLn versionString >> System.Exit.exitSuccess
        VersionCtx  -> putStrLn (versionString ++ BS.toString versionContext) >> System.Exit.exitSuccess
        PrintHscOptions -> do

...
appendHoTcInfo :: HoTcInfo -> HoTcInfo -> HoTcInfo
appendHoTcInfo (HoTcInfo aa ab ac ad ae af ag ah) (HoTcInfo aa' ab' ac' ad' ae' af' ag' ah') = HoTcInfo (mappend aa aa')(mappend ab ab')(mappend ac ac')(mappend ad ad')(mappend ae ae')(mappend af af')(mappend ag ag')(mappend ah ah')
...
appendHoBuild :: HoBuild -> HoBuild -> HoBuild
appendHoBuild (HoBuild aa ab ac) (HoBuild aa' ab' ac') = HoBuild (mappend aa aa')(mappend ab ab')(mappend ac ac')
